...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('application/views/reportes/fpdf/logo.png', 10, 10, 40); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      $this->SetFont('Arial', 'B', 19); //tipo fuente, negrita(B-I-U-BIU), tamañoTexto
      $this->Cell(45); // Movernos a la derecha
      $this->SetTextColor(0, 0, 0); //color
      //creamos una celda o fila
      $this->Cell(170, 15, utf8_decode('REPORTE GENERAL DE VENTAS'), 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      */
      ...
      $this->Cell(60, 10, utf8_decode('Comprobante'), 1, 0, 'C', 1);
